...
class menus:
    def cred():
        print(f'''
    {Fore.BLUE}[{Fore.RED}Youtube{Fore.BLUE}] sosaondabeat
    {Fore.BLUE}[{Fore.RED}Discord{Fore.BLUE}] killintheseopps
        ''')
        Output.PETC()
...
class gui:
    ...
    def print_menu():
        ...
        logo = f'''{r} 
             multi-tools!
                                    dont use this in serious mods this is very dangerous for unknown people. 
                                                              made with love by cashflow
                    numele pc: {pc_username}
...
{r}╚═══                              ═══╝ ╚═══                                ═══╝ ╚═══                                ═══╝'''
    ...
    def main_menu():
        while True:
            ...
            gui.print_menu()
            pc_username = config._get("xvirus_username")
            print(f'{r}┌──<{pc_username}@Multi-tools>─[~]')
